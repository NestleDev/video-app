...
"use strict";
eval("\n\nvar GoogleMap = __webpack_require__(/*! ./components/api.google */ \"./source/js/components/api.google.js\");\nvar config = __webpack_require__(/*! ./config.json */ \"./source/js/config.json\");\nvar DOM = __webpack_require__(/*! ./components/dom */ \"./source/js/components/dom.js\");\nvar OPS = __webpack_require__(/*! ./components/ops */ \"./source/js/components/ops.js\");\nvar Accordeon = __webpack_require__(/*! ./components/accordeon */ \"./source/js/components/accordeon.js\");\nvar Request = __webpack_require__(/*! ./components/request */ \"./source/js/components/request.js\");\nvar Video = __webpack_require__(/*! ./components/video */ \"./source/js/components/video.js\");\nvar DOM_API = new DOM();\n\nvar ops = new OPS('.maincontent', {\n    events: {\n        keyup: true\n    },\n    controls: ['.pagination'],\n    duration: 1000,\n    animate: 'cubic-bezier(0.075, 0.82, 0.165, 1)'\n});\n\nnew Accordeon('.team-accordeon', {\n    active: 2,\n    autoHeight: true,\n    duration: 700,\n    animate: 'cubic-bezier(0.075, 0.82, 0.165, 1)'\n});\n\nnew Accordeon('.menu-accordeon', {\n    duration: 300\n}, function (target) {\n    target.querySelector('.close').addEventListener('click', function () {\n        target.classList.remove('active');\n    });\n});\n\nnew Request({\n    form: {\n        selector: '#send-mail',\n        valid: true,\n        success: function success(data, target) {\n            DOM_API.showPopup('#popup-status', {\n                content: data.message\n            });\n\n            target.reset();\n        },\n        error: function error(_error) {\n            DOM_API.showPopup('#popup-status', {\n                content: '\\u0423\\u043F\\u0441... \\u041E\\u0448\\u0438\\u0431\\u043A\\u0430 ' + _error.status + ' - ' + _error.statusText\n            });\n        }\n    }\n});\n\nnew Video('.video');\n\nvar myApiGoogle = new GoogleMap();\n\nmyApiGoogle.init('#map', {\n    center: { lat: 59.944098, lng: 30.307179 },\n    zoom: window.innerWidth > 480 ? 14 : 13,\n    disableDefaultUI: true,\n    styles: config.googleMap.style\n});\n\nconfig.googleMap.markers.forEach(function (coords) {\n    myApiGoogle.createPlacemark(coords, function (data) {\n        DOM_API.showPopup('#popup-status', { content: data.address });\n    });\n});\n\n$(document).ready(function () {\n    $(\".owl-carousel\").owlCarousel({\n        items: 1,\n        loop: true,\n        nav: true,\n        navContainerClass: 'slider__controls',\n        navClass: ['slider__control slider__control_prev', 'slider__control slider__control_next'],\n        navText: [\"<svg class=\\\"slider__control-icon\\\"><use xlink:href=\\\"images/icons/sprite.svg#arrow-scroll\\\" /></svg>\", \"<svg class=\\\"slider__control-icon\\\"><use xlink:href=\\\"images/icons/sprite.svg#arrow-scroll\\\" /></svg>\"],\n        dotsContainer: '.slider__dots',\n        smartSpeed: 300\n    });\n\n    $('input[name=\"phone\"]').inputmask({\n        mask: '+7(999)999-99-99'\n    });\n\n    $('[data-review]').on('click', function () {\n        var request = new Request();\n\n        request.send({\n            url: '/reviews/' + this.dataset.review,\n            success: function success(data) {\n                DOM_API.showPopup('#popup-reviews', data);\n            },\n            error: function error(_error2) {\n                DOM_API.showPopup('#popup-status', {\n                    content: '\\u0423\\u043F\\u0441... \\u041E\\u0448\\u0438\\u0431\\u043A\\u0430 ' + _error2.status + ' - ' + _error2.statusText\n                });\n            }\n        });\n    });\n\n    $('.nav__link, .button_action_scroll, .arrow-down').on('click', function () {\n        var index = this.getAttribute('href').substring(1);\n\n        ops.slideTo(parseInt(index));\n\n        $('.header').removeClass('header_fullscreen');\n    });\n\n    $('.hamburger, .nav__close').on('click', function () {\n        $('.header').toggleClass('header_fullscreen');\n    });\n});\n\n//# sourceURL=webpack:///./source/js/app.js?");

/***/ }),

/***/ "./source/js/components/accordeon.js":
/*!*******************************************!*\
  !*** ./source/js/components/accordeon.js ***!
  \*******************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\n__webpack_require__(/*! babel-polyfill */ \"./node_modules/babel-polyfill/lib/index.js\");\n\nmodule.exports = function () {\n    function _class() {\n        _classCallCheck(this, _class);\n    }\n\n    _createClass(_class, [{\n        key: 'init',\n        value: function init(el, config) {\n            this.map = new google.maps.Map(document.querySelector(el), config);\n        }\n    }, {\n        key: 'createPlacemark',\n        value: function createPlacemark(coords, cb) {\n            var _this = this;\n\n            var marker = new google.maps.Marker({\n                position: coords,\n                icon: window.innerWidth < 480 ? null : './images/icons/map-marker.svg',\n                animation: google.maps.Animation.BOUNCE,\n                map: this.map\n            });\n\n            marker.addListener('click', function _callee() {\n                return regeneratorRuntime.async(function _callee$(_context) {\n                    while (1) {\n                        switch (_context.prev = _context.next) {\n                            case 0:\n                                if (!cb) {\n                                    _context.next = 7;\n                                    break;\n                                }\n\n                                _context.t0 = cb;\n                                _context.next = 4;\n                                return regeneratorRuntime.awrap(_this.getAddress(coords));\n\n                            case 4:\n                                _context.t1 = _context.sent;\n                                _context.t2 = {\n                                    address: _context.t1\n                                };\n                                (0, _context.t0)(_context.t2);\n\n                            case 7:\n                            case 'end':\n                                return _context.stop();\n                        }\n                    }\n                }, null, _this);\n            });\n        }\n    }, {\n        key: 'getAddress',\n        value: function getAddress(coords) {\n            var response;\n            return regeneratorRuntime.async(function getAddress$(_context2) {\n                while (1) {\n                    switch (_context2.prev = _context2.next) {\n                        case 0:\n                            _context2.next = 2;\n                            return regeneratorRuntime.awrap(this.geocoder(coords));\n\n                        case 2:\n                            response = _context2.sent;\n                            return _context2.abrupt('return', response[0].formatted_address);\n\n                        case 4:\n                        case 'end':\n                            return _context2.stop();\n                    }\n                }\n            }, null, this);\n        }\n    }, {\n        key: 'geocoder',\n        value: function geocoder(coords) {\n            return new Promise(function (resolve, reject) {\n                var geocoder = new google.maps.Geocoder();\n\n                geocoder.geocode({ 'location': coords }, function (result, status) {\n                    if (status === 'OK') {\n                        resolve(result);\n                    } else {\n                        reject(new Error('Geocoder failed due to: ' + status));\n                    }\n                });\n            });\n        }\n    }]);\n\n    return _class;\n}();\n\n//# sourceURL=webpack:///./source/js/components/api.google.js?");

/***/ }),

/***/ "./source/js/components/dom.js":
/*!*************************************!*\
  !*** ./source/js/components/dom.js ***!
  \*************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nmodule.exports = function () {\n    function _class() {\n        _classCallCheck(this, _class);\n    }\n\n    _createClass(_class, [{\n        key: '$',\n        value: function $(selector) {\n            var parent = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : document;\n\n            return parent.querySelector(selector);\n        }\n    }, {\n        key: 'showPopup',\n        value: function showPopup(selector, data) {\n            var popup = this.$(selector);\n            var overlay = popup.parentNode;\n\n            for (var key in data) {\n                if (data.hasOwnProperty(key)) {\n                    this.$('.popup__' + key, popup).textContent = data[key];\n                }\n            }\n\n            overlay.classList.add('overlay_active');\n            popup.classList.add('popup_show');\n\n            this.$('.popup__close', popup).addEventListener('click', function () {\n                overlay.classList.remove('overlay_active');\n                popup.classList.remove('popup_show');\n            }, { once: true });\n        }\n    }]);\n\n    return _class;\n}();\n\n//# sourceURL=webpack:///./source/js/components/dom.js?");

/***/ }),

/***/ "./source/js/components/ops.js":
/*!*************************************!*\
  !*** ./source/js/components/ops.js ***!
  \*************************************/
/*! no static exports found */
